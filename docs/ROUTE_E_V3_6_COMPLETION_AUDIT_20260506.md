...
| B20 `03`/`04` boundary-clock branch masses | `RouteEB20.allPairTime03BoundaryClockBranchMassTotal_eq_target`, `RouteEB20.allPairTime04BoundaryClockBranchMassTotal_eq_target`, `RouteEB20.allPairTime0304BoundaryClockBranchMassTotal_eq_target_sum`; generated exact samples `q=0..9` support the underlying branch formulas | aggregate targets added |

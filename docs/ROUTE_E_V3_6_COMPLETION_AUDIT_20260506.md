...
1. prove the enumeration is bijective, preferably via an explicit
   `boundaryNodeRank` inverse;
2. build the concrete `BoundaryQuotientCycleEnumeration` instance, then
   conjugate to `finRotate`;

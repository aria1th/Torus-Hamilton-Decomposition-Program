...
samples found no triple simultaneously matching the required single-cycle
returns and the full paper pair-relation signature
`((1,1,7,7), (1,1,3,11), (8,8))`.  The next useful proof step is therefore not a

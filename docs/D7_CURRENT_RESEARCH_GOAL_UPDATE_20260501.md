...
1. Provide a uniform `BridgeConcreteOrbitPackage` for every odd `m >= 5`;
   after the latest interface, this means row permutations, D3
   fiber-layer/permutation data, base return coverage, and fiber monodromy for
   the canonical folded return.

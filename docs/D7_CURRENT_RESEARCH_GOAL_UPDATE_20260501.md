...
1. Provide a uniform `BridgeConcretePowRankPackage` for every odd `m >= 5`;
   ...
   stepped by the canonical folded base return, and fiber monodromy for the
   canonical folded return.

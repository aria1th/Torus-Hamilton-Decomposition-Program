...
- `D7Odd/Handoff/Additive4Plus2.lean` now contains the concrete
  ...
  matching the fiber-rank target used by the concrete bridge package.  Its
  `ProductRootSchedule` namespace also has the local bridge

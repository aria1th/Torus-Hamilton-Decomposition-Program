...
| Prefix-count signed foundation | `Parts`; `SignedPrefixCounts`; `SignedPrefixCounts.toParts_admissible`; `signedVal_coprime_of_odd`; `pred_mod_pos_of_odd` | Lean-checked in `RoundComposite/PrefixCount.lean` | Closed foundation |

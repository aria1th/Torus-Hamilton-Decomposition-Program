...
Concrete.OddSuccessorPhaseSplitBufferReservoirData.nonbufferTokenBaseRight
Concrete.OddSuccessorPhaseSplitBufferReservoirData.bufferTokenBaseRight
Concrete.OddSuccessorPhaseSplitBufferReservoirData.nonzeroSymbolPred
Concrete.OddSuccessorPhaseSplitBufferReservoirData.nonbufferTokenBaseRight_eq_token_right
...
Concrete.OddSuccessorPhaseSplitBufferReservoirData.ReservoirSitePlan.moveZeroColorOfMove_toNonzeroZeroSwapMove
Concrete.OddSuccessorPhaseSplitBufferReservoirData.ReservoirSitePlan.moveRightColorOfMove_toNonzeroZeroSwapMove
Concrete.OddSuccessorPhaseSplitBufferReservoirData.ReservoirSitePlan.thresholdMoveList
Concrete.OddSuccessorPhaseSplitBufferReservoirData.ReservoirSitePlan.toNonzeroZeroSwapMove_mem_thresholdMoveList
...
Concrete.OddSuccessorPhaseSplitBufferReservoirData.ReservoirSitePlan.thresholdTokenNonzeroDelta
Concrete.OddSuccessorPhaseSplitBufferReservoirData.ReservoirSitePlan.thresholdTokenNonzeroDelta_nonbuffer
Concrete.OddSuccessorPhaseSplitBufferReservoirData.ReservoirSitePlan.thresholdTokenNonzeroDelta_buffer01
Concrete.OddSuccessorPhaseSplitBufferReservoirData.ReservoirSitePlan.thresholdTokenNonzeroDelta_buffer02
Concrete.OddSuccessorPhaseSplitBufferReservoirData.ReservoirSitePlan.thresholdMoveList_nonzero_delta_eq_token_sum
Concrete.OddSuccessorPhaseSplitBufferReservoirData.ReservoirSitePlan.thresholdMoveList_nonzero_delta_eq_family_sums
Concrete.OddSuccessorPhaseSplitBufferReservoirData.ReservoirSitePlan.zeroReservoirDelta
...
Concrete.OddSuccessorPhaseSplitBufferReservoirData.ReservoirSitePlan.thresholdCanonicalQuota_buffer02_copy
...
Concrete.OddSuccessorPhaseSplitBufferReservoirData.exists_primitiveActiveSymboling_of_reservoirSitePlan
...
BaseTail.Trades.CanonicalNonzeroZeroReservoirScript.symbolingWithResidues
...
`ReservoirSitePlan.exists_thresholdMoveCanonicalReservoirScript_of_exists_quota_nonzeroSolved`
matches the paper order more closely: build the full reservoir baseline first,
...
nonzero trade-delta rewrite is now packaged by
`ReservoirSitePlan.thresholdMoveList_nonzero_delta_eq_token_sum` and
...
`CanonicalNonzeroZeroReservoirScript.symbolingWithResidues` then turns this
script into the active-block canonical residue symboling, and
`OddSuccessorPhaseSplitBufferReservoirData.exists_primitiveActiveSymboling_of_reservoirSitePlan`
packages the primitive active symboling needed by the prefix lift.  The
successor small-modulus endpoint is now exposed as
...
the canonical local-trade endpoint.  The universal successor-scoped canonical
local-trade theorem name remains available as an abstraction, but the concrete
phase-split buffer route now bypasses it and closes the small-modulus
slack-packet endpoint directly.
...
Concrete.oddSuccessorClosureGoal_of_v75_phaseSplitBufferReservoir
Concrete.odd_modulus_tori_all_dimensions_of_v75_phaseSplitBufferReservoir
Concrete.oddModulusToriAllDimensionsGoal_of_v75_phaseSplitBufferReservoir
Concrete.oddModulusToriV75PreCorrectionReturnInputsGoal_of_preCorrectionClosedInputs
Concrete.oddModulusToriV75PreCorrectionReturnInputsGoal_of_preCorrection

...
4. **D5 even Route-E.**  Find count/slot families covering every even
   ...
   `sum tau = m^4`.  Keep the open-port affine chart target as a checked
   section-level lemma, not as the final all-even return theorem.

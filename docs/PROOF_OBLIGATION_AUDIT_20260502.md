...
4. **D5 even Route-E.**  Find count/slot families covering every even
   ...
   `sum tau = m^4`.  The canonical open-port carry law is now a checked
   section-level lemma, not the final all-even return theorem; the remaining
   work is the full Route-E symbolic small-seam certificate.

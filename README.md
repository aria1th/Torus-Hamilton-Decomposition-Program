...
- `D7Odd/Handoff/Additive4Plus2.lean`: root-state coordinate equivalence `A7(m) ~= A5(m) x A3(m)`, D7 slot-step conjugacy, and product-side certificate adapters into the D7 root-flat and shared layered-lift targets.

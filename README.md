...
- `D7Odd/Handoff/Additive4Plus2BridgeKappa.lean`: concrete state-dependent bridge `kappa` combining the D5 base slot rule with an S3 fiber permutation, with bijectivity, concrete row-schedule row-Latin adapters, and D3 compiler-to-`phi` adapters.

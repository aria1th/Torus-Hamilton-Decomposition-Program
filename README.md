...
- `D7Odd/Handoff/Additive4Plus2ConcreteGoal.lean`: concrete all-zero-set bridge target: once row permutations, D3 fiber-layer/permutation data, return equality, base cover, and fiber monodromy are supplied, the local row/layer facts are filled in automatically and the odd D7 endpoint follows.

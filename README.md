...
- `D7Odd/Handoff/Additive4Plus2ConcreteGoal.lean`: concrete all-zero-set bridge target: once row permutations, D3 fiber-layer/permutation data, a base-return rank step into `ZMod (m^4)`, and fiber monodromy are supplied for the canonical folded return, the local row/layer facts, folded-return bijectivity, product-return equality, and base orbit coverage are filled in automatically and the odd D7 endpoint follows.

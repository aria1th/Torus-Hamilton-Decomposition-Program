...
FILES = {
    ...
    "r42_bad_intercept_carry_split_stress_even": ROOT
    / "certs"
    / "routeE_r42_bad_intercept_carry_split_even_q6_8_10.json",
    "r42_bad_intercept_carry_split_stress_odd": ROOT
    / "certs"
    / "routeE_r42_bad_intercept_carry_split_odd_q7_9_11.json",
...
def build_audit() -> dict[str, Any]:
    ...
    r42_bad_intercept_carry_split_stress_even = load_json(
        FILES["r42_bad_intercept_carry_split_stress_even"]
    )
    r42_bad_intercept_carry_split_stress_odd = load_json(
        FILES["r42_bad_intercept_carry_split_stress_odd"]
    )
    ...
    checklist = [
        ...
        item(
            ...
            r42_bad_intercept_carry_split_stress_verification.get("schema")
            == "routeE_r42_bad_intercept_carry_split_stress_verification_v1"
            and r42_bad_intercept_carry_split_stress_verification.get("ok") is True
            and r42_bad_intercept_carry_split_stress_verification.get(
                "diagnostic_result", {}
            ).get("simple_one_or_two_feature_schema_stable")
            is False
            and r42_bad_intercept_carry_split_stress_verification.get(
                "diagnostic_result", {}
            ).get("one_feature_hits_per_branch")
            ...
            == "20->26|L1|B7:7|R0:0"
            and r42_bad_intercept_carry_split_stress_even.get("q_values")
            == [6, 8, 10]
            and r42_bad_intercept_carry_split_stress_odd.get("q_values")
            == [7, 9, 11],
